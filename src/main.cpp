...
// configuration step. It creates a namespace called `cpp-build-template-test`. You can modify
...
int main(int argc, const char **argv)
{
 ...
 Options:
    ...
    std::map<std::string, docopt::value> args = docopt::docopt(USAGE,
      ...
      fmt::format("{} {}",
        cpp-build-template-test::cmake::project_name,
        cpp-build-template-test::cmake::project_version));// version string, acquired
